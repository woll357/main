	...
	<c:when test="${param.aotcont=='in' }">
		<table border="">
			<tr>
				...
				<td><a href="../hotelsell/HotelReserveList?aotcont=in">매출내역</a></td>
				<td><a href="../hotelsell/HotelSalesList?aotcont=in">예약내역</a></td>
		...
		<table border="">
			<tr>
				...
				<td><a href="../Manager/AirItem_List?partner=in">항공권상품목록조회</a></td>
						<td><a href="../Manager/Airplane_List?aotcont=in">비행기목록</a></td>
