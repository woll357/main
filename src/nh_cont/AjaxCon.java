...
public class AjaxCon extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		MvcAction action;
		try {
			action = (MvcAction)Class.forName("greenAjax."+service).newInstance();
			MvcForward forward=action.execute(request, response);
			
			RequestDispatcher dispatcher = request.getRequestDispatcher("/view/greenAjax/"+service+".jsp");
