...
public class ReserveCompanyList implements MvcAction {
	...
	public MvcForward execute(HttpServletRequest request, HttpServletResponse response) {
		...
		if(comcode.substring(0, 1).equals("A")) {
			...
			ArrayList<BasketpaidDTO> comReserveLists = new BasketpaidDAO().comReserveList(bpdto);
			
			request.setAttribute("reserveLists", comReserveLists);
